...
namespace UNOServer
{
    ...
    class Program
    {
         ...
         * Connect;ID                                                                 | Info;ID         
         * Disconnect;ID                                                              | InitializeStat;ID;Luot;SoLuongBai;CardName;CardName...;CardName (7 bài người chơi + 1 bài hệ thống tự đánh)              
        ...
        */
        ...
        private static void HandleConnect(string[] Message, PLAYER User)
        {
        ...
        private static void HandleDisconnect(string[] Message)
        {
        ...
        private static void HandleDanhBai(string[] Message, PLAYER User)
        {
            ...
            MoBai.mobai.Add(Message[3]); //Thêm lá bài đã đánh vào bài đã mở 
